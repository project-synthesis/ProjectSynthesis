...
### Added
- **Taxonomy Observatory Tier 1 — three-panel observability dashboard** (ADR-006 first iteration) — new pinned `OBSERVATORY` tab in the workbench tablist mounts `TaxonomyObservatory.svelte`, a flex-grid shell composing three panels:
