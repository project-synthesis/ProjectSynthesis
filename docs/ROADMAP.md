...
- **v0.4.22** — Probe Tier 2 (save-as-suite + replay + UI + regression alarm) + audit-hook WARN→RAISE flip — **READY-TO-SHIP ≥2026-05-18** (post-soak SG-2026-05-11; 16 cycles complete, 15 soak findings caught + addressed pre-ship, all CI green, rebase against `origin/main` verified conflict-free across 84 commits)
- **v0.4.23** — Probe Tier 3 (release.sh CI + probe→seed promotion + drill-into-cluster) — **PLANNED**
