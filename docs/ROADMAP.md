...
| **F** | **Audit-as-Code** — automate the `.claude/skills/brand-guidelines/references/3d-visualization.md` F1–F19 audit checklist as a test gate. Every audit checklist line becomes either a source-grep test or a runtime contract test. Failing the audit = failing CI. Replaces today's manual audit-pass. | **v0.4.27** | **Planned** (spec seed in program-context doc) | A, B, C, D, E (every preceding sub-project's contract is one of the things audited) | 1–2 sessions. Final closure of the program. |
...
- **v0.4.27** — Pattern Graph hardening **Sub-project F — Audit-as-Code** (F1–F19 canon checklist automated as test gate; replaces manual audit-pass) — **PLANNED**. Final closure of the Pattern Graph hardening program.
