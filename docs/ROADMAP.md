...
- **v0.4.22** — Probe Tier 2 (save-as-suite + replay + UI + regression alarm) + audit-hook WARN→RAISE flip — **READY-TO-SHIP ≥2026-05-18** (post-soak SG-2026-05-11; 16 cycles complete, **21 soak findings** caught + addressed pre-ship (5 HIGH + 6 MED + 8 LOW + 2 architectural), all CI green, rebase against `origin/main` verified conflict-free across 84 commits, 3774/3774 backend tests PASS)
