...
- **v0.4.25** — Pattern Graph hardening **Sub-project D — Scene Builder Extraction** (split 774-line `rebuildScene` into 5 builder modules: `ClusterBuilder`, `DomainBuilder`, `EdgeBuilder`, `RingBuilder`, `DustBuilder`; target `SemanticTopology.svelte` < 800 lines from 2834) — **PLANNED**. Largest of the 6 sub-projects — ~32 dispatches across 6 cycles.
