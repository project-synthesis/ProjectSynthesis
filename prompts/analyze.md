...
2. **Intent label** — A concise 3-6 word noun phrase describing the core intent of this prompt (e.g., "dependency injection refactoring", "API error handling", "landing page layout"). No parenthetical qualifiers, no scope words like "full", "complete", "partial". Just the topic.
