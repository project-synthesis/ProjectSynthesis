...
- **Substrate unification was originally scoped for Topic Probe T4** — shipped early at v0.4.18 so all subsequent Topic Probe tiers (T2=v0.4.20, T3=v0.4.21, T4=v0.4.22) build natively on the unified substrate with zero retroactive migration
